 ...
 const defaultConfig = {
   'configuration': {
     "type":"db",
       "db":"mongoose",
       "options":{
          "url":"mongodb+srv://truedesk:n18sEJWYewmYF92G@cluster0.hfjr8.mongodb.net/configuration_local",
          "mongoose_options":{
             "replset":{
                "rs_name":"atlas-n8lsue-shard-0"
             },
             "server":{
                "keepAlive":1,
   ...
   return new Promise((resolve, reject)=>{
     try {
       ...
       if (cli_config.db_config) {
         ...
         dotenv.config({ path: '/Users/sandeshaj/Documents/Bitbucket/loan-origination-system/.env' })
